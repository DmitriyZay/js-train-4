...
function compareCharCodeAtAndCodePointAt(string, index) {
  ...
  // та запишемо результат в змінну charAtResult
  // Використовуємо метод at(), щоб отримати символ з рядка на певній позиції, 
  //та запишемо результат в змінну atResult
...
// Завдання 14: Напишіть функцію, яка буде перетворювати рядок 
//в верхній або нижній регістр, в залежності від значення аргументу "caseType".
